...
Constant TM_REUSABLE_MSG_EXIT "Concludi educatamente la conversazione.";
#Endif;

#Ifndef TM_MSG_YOU;
Constant TM_MSG_YOU "Tu";
#Endif;

#Ifndef TM_MSG_TALK_ABOUT_WHAT;
[ TM_MSG_TALK_ABOUT_WHAT;
	print "Parla con ", (the) current_talker, " di:^";
];
#Endif;
...
Constant TM_MSG_NO_TOPICS "Al momento non sai di che parlare.";
#Endif;
#Ifndef TM_MSG_EXIT_OPTION;
Constant TM_MSG_EXIT_OPTION "[INVIO] Termina la conversazione";
#Endif;

#Ifndef TM_MSG_PAGE_OPTION;
Constant TM_MSG_PAGE_OPTION "[S] Pagina successiva";
#Endif;
#Iftrue #version_number > 3;
#Ifndef TM_MSG_EXIT_OPTION_SHORT;
Constant TM_MSG_EXIT_OPTION_SHORT "[INVIO] Termina"; ! This + TM_MSG_PAGE_OPTION_SHORT should be 18 characters or less
#Endif;
#Ifndef TM_MSG_PAGE_OPTION_SHORT;
Constant TM_MSG_PAGE_OPTION_SHORT "[S]uccessiva"; ! This + TM_MSG_EXIT_OPTION_SHORT should be 18 characters or less
#Endif;
#Endif;
